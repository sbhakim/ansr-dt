...
% Last updated: 2026-03-27T17:43:57.887657
...
neural_rule_15 :- feature_threshold(efficiency_index, _, low), feature_threshold(pressure, _, low), feature_threshold(temperature, _, low), feature_threshold(vibration, _, low).  % Confidence: 1.000, Extracted: 2025-04-11T06:56:36.426576, Activations: 15
...
neural_rule_18 :- feature_threshold(pressure, _, low), feature_threshold(temperature, _, low), feature_threshold(vibration, _, low).  % Confidence: 1.000, Extracted: 2025-04-11T06:56:36.426576, Activations: 15
...
neural_rule_28 :- correlated(temperature, vibration), feature_threshold(efficiency_index, _, low), feature_threshold(pressure, _, low), feature_threshold(temperature, _, low), feature_threshold(vibration, _, low).  % Confidence: 0.940, Extracted: 2026-03-27T17:43:57.887452, Activations: 13
